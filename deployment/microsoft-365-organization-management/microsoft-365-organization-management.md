...
Before starting to work with data, KODO first needs to get access to your Microsoft Office365 Organization.
...
Follow the instruction to register KODO4Cloud application and add O365 organization to KODO:
