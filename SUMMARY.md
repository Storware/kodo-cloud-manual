...
* [Deployment](deployment/README.md)
  ...
  * [Backup destinations](deployment/staging-space-and-backup-destination-configuration/README.md)
    * [Filesystem](deployment/staging-space-and-backup-destination-configuration/filesystem/README.md)
      * [Regular filesystem](deployment/staging-space-and-backup-destination-configuration/filesystem/regular-filesystem.md)
      * [Virtual Data Optimizer \(VDO\)](deployment/staging-space-and-backup-destination-configuration/filesystem/virtual-data-optimizer-vdo.md)
