...
Go to the [Add Microsoft 365 organization using the Setup Assistant ](../../../deployment/first-steps-after-deployment/microsoft-365-organization-management/add-the-microsoft-365-organization-using-the-setup-assistant.md)chapter to learn how to add Microsoft 365 organization using dedicated Setup Assistant.
