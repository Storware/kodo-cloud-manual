# Organization plug-in \(Setup Assistant\)
...
Go to the [Launch backup&recovery](launch-backup-and-recovery.md) chapter to learn how to backup and recover users' Microsoft 365 data.
